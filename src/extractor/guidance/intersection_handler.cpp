                                                      ...
                                                      const ConnectedRoad &road) const
{
    ...
    bool on_ramp = in_data.road_classification.road_classification.isRampClass();

    bool onto_ramp = out_data.road_classification.road_classification.isRampClass();
                                     ...
                                     ConnectedRoad &right) const
{
    ...
    const bool low_priority_left =
        node_based_graph.GetEdgeData(left.turn.eid)
            .road_classification.road_classification.isLowPriorityRoadClass();
    const bool low_priority_right =
        node_based_graph.GetEdgeData(right.turn.eid)
            .road_classification.road_classification.isLowPriorityRoadClass();
